...
user_choices = {    
    ...
    'delete_banking_choices' : ['3', 'three', 'Three', 'delete', 'Delete', 'Delete Banking Information', 'Delete banking information', 'delete banking information', 'Delete Saved Banking Information', 'Delete saved banking information', 'delete saved banking information', 'Delete Saved Banking Info', 'Delete saved banking info', 'delete saved banking info'],
    ...
    'delete_login_choices' : ['3', 'three', 'Three', 'delete', 'Delete', 'Delete Login', 'Delete login', 'delete login', 'Delete Saved Login', 'Delete saved login', 'delete saved login'],
    ...
    'edit_address_choices' : ['4', 'four', 'Four', 'Edit', 'edit', 'Edit Address', 'Edit address', 'edit address', 'Edit Saved Address', 'Edit saved address', 'edit saved address'],
    'edit_banking_choices' : ['4', 'four', 'Four', 'Edit', 'edit', 'Edit Banking Information', 'Edit banking information', 'edit banking information', 'Edit Saved Banking Information', 'Edit saved banking information', 'edit saved banking information', 'Edit Saved Banking Info', 'Edit saved banking info', 'edit saved banking info'],
    'edit_ssn_choices' : ['4', 'four', 'Four', 'Edit', 'edit', 'Edit Social Security Number',' Edit social security number', 'edit social security number', 'Edit Saved Social Security Number', 'Edit saved social security number', 'edit saved social security number', 'Edit Social Security', 'Edit social security', 'edit social security', 'Edit Saved Social Security', 'Edit saved social security', 'edit saved social security', 'Edit SSN', 'Edit ssn', 'edit ssn', 'Edit Saved SSN', 'Edit saved ssn', 'edit saved ssn'], 
    'edit_phone_number_choices' : ['4', 'four', 'Four', 'Edit', 'edit', 'Edit Phone Number', 'Edit phone number', 'edit phone number', 'Edit Saved Phone Number', 'Edit saved phone number', 'edit saved phone number', 'Edit Number', 'Edit number', 'edit number', 'Edit Saved Number', 'Edit saved number', 'edit saved number'],
    ...
    'edit_birth_choices' : ['4', 'four', 'Four', 'Edit', 'edit', 'Edit', 'Edit Birthday', 'Edit birthday', 'edit birthday', 'Edit Date Of Birth', 'Edit Date of Birth', 'Edit date of birth', 'edit date of birth', 'Edit Saved Birthday', 'Edit saved birthday', 'edit saved birthday', 'Edit Saved Date Of Birth', 'Edit Saved Date of Birth', 'Edit saved date of birth', 'edit saved date of birth'],
    ...
    'edit_occupation_choice' : ['4', 'four', 'Four', 'Edit', 'edit', 'Edit Occupation', 'Edit occupation', 'edit occupation', 'Edit Saved Occupation', 'Edit saved occupation', 'edit saved occupation'],
    ...
    'edit_insurance_choices' : ['4', 'four', 'Four', 'Edit', 'edit', 'Edit Insurance', 'Edit insurance', 'edit insurance', 'Edit Saved Insurance', 'Edit saved insurance', 'edit saved insurance', 'Edit Saved Insurance Information', 'Edit saved insurane information', 'edit saved insurance information', 'Edit Saved Insurance Info', 'Edit saved insurance info', 'edit saved insurance info'],
    'edit_driving_choices' : ['4', 'four', 'Four', 'Edit', 'edit', 'Edit Drivers License', 'Edit drivers license', 'edit drivers license', 'Edit Saved Drivers License', 'Edit saved drivers license', 'edit saved drivers license', 'Edit Saved Driving Information', 'Edit saved driving information', 'edit saved driving information', 'edit Save Driving Info', 'Edit saved driving info', 'edit saved driving info'],
    ...
    'edit_legal_choices' : ['4', 'four', 'Four', 'Edit', 'edit', 'Edit Legal Information', 'Edit legal information', 'Edit Saved Legal Information', 'Edit saved legal information', 'edit saved legal information', 'Edit Saved Legal Info', 'Edit saved legal info', 'edit saved legal info'],
